...
public class UI : MonoBehaviour
{
    ...
    public void result(float total, float totalScore)
    {
        ...
        } else if (score >= 6.0f)
        {
            ...
            Message.text += "과일 속임수 게임을 통해 주의력을 검사했어요!\n\n" +
                            " <sprite name=\"running\">훈련하면 더 좋아질 수 있어요!\n" +
        ...
        } else if (score >= 5.0f)
        {
            ...
            Message.text += "과일 속임수 게임을 통해 주의력을 검사했어요!\n\n" +
                            " <sprite name=\"brain\">조금 더 자주 훈련하면 좋아질 수 있어요!\n" +
        ...
        } else
        {
            ...
            Message.text += "과일 속임수 게임을 통해 주의력을 검사했어요!\n\n" +
                            ...
                            "<sprite name=\"weight\"> 조금 더 연습하면 주의력이 유지되고 향상될 거예요! \n" +
                            "<sprite name=\"check\">다음과 같은 활동을 추천드려요!" +
